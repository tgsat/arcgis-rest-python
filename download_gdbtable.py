...
def create_replica(service_url, username, password, token_url, output_dir):
    ...
    params = {
        ...
        "layers": "1",  # Nomor layer, ganti sesuai kebutuhan
    ...
    zip_output = os.path.join(output_dir, "lampung_attachment.gdb.zip")
...
service_url = config.FEATURE_LAYER_URL
token_url = config.TOKEN_URL
username = config.GIS_USERNAME
password = config.GIS_PASSWORD
output_dir = config.SAVE_FOLDER2
